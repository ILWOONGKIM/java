...
○	중첩 클래스의 종류(4가지)
	...
	2. 내부 클래스(inner class)
	   ...
	   - 내부 멤버 클래스는 외부에서 단독으로 객체를 생성하여 사용할 수 있다.
...
class Test
{
	static int a = 10;					// static - 공유, 탄생시점
	int b = 20;			

	public static class StaticNested	// static
	// static 이 들어간 inner class → 중첩 내부 클래스
	{
		int c = 30;
		...
		void write()
		{
			...
			//-- static이 태어났을때 b는 아직 안태어남
			System.out.println("c : " + c);
			//-- static class 안에 c가있어서 같은시점에 태어났음
		}
	}
...
public class Test127
{
	public static void main(String[] args)
	{
		...
		// static이 클래스 변수인 이유 : 클래스 생성 시점에 태어남, 클래스이름으로 접근할 수 있음
		//Test.a
		//Test.method()
